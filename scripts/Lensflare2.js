...
THREE.LensflareElement.Shader = {
    ...
    // tweaking this results in different lens flare characteristics
    // distance tweaks can be done with the vVisibility *= 1.x scalar
	...
	vertexShader: [
		...
		'	vVisibility *= 1.1 - visibility.g / 9.0;',
